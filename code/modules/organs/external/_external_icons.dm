...
//###################################################################################################################
//######### MITHRA ALERT OVERRIDE INTO BAY'S ORIGINAL CALL mark_s.Blend(markings[M]["color"], mark_style.blend) #####
//############################################################ VESTA.BAY ############################################

			//mark_s.Blend(markings[M]["color"], mark_style.blend) // ---> Baystation Original call @r4iser
			mark_s.Blend(markings[M]["color"], mark_style.color_blend_mode) // MITHRA CUSTOM CALL
...
//###################################################################################################################
//######### MITHRA ADDS CUSTOM ROUTINES TO organ/external/on_update_icon( ###########################################
//############################################################ VESTA.BAY ############################################
...
//###################################################################################################################
//######### MITHRA ALERT OVERRIDE INTO BAY'S ORIGINAL CALL icon_cache_key = #########################################
//############################################################ VESTA.BAY ############################################
...
//###################################################################################################################
//######### MITHRA ALERT OVERRIDE BAYSTATION ORIGINAL CALL FOR mark_s.Blend() #######################################
//################################################################################# VESTA.BAY #######################
...
//###################################################################################################################
//######### MITHRA ALERT OVERRIDE BAYSTATION ORIGINAL CALL FOR I.Blend() ############################################
//################################################################################# VESTA.BAY #######################

			//I.Blend(rgb(h_col[1],h_col[2],h_col[3]), ICON_ADD)	//BAYSTATION ORIGINAL CALL
			I.Blend(rgb(h_col[1],h_col[2],h_col[3]), ICON_MULTIPLY) //MITHRA CUSTOM CALL
...
//###################################################################################################################
//######### MITHRA DEACTIVATED CUSTOM CALL TO ADD MARKINGS TO SYNTHS - ON BOH'S MODEL ###############################
//######################################################################## VESTA.BAY ################################

		/*
		// BoH ORIGINAL COMMENT: edit to enable markings on synths -Dunno why it's disabled ATM
