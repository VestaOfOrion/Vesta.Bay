//Dagon ID Cards (they have to be here to make the outfits work, no way around it)
...
/obj/item/weapon/card/id/torch/crew
	desc = "An identification card issued to SolGov crewmembers aboard the NTSS Dagon."
	color = "#d3e3e1"
