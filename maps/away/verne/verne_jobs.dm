...
/datum/job/submap/CTI_Undergraduate_Xenoscience_Researcher
	...
	to find the Verne running at low capacity, under-staffed, with much of the automated life support systems doing the heavy lifting."
	whitelisted_species = list(SPECIES_HUMAN,SPECIES_SPACER,SPECIES_GRAVWORLDER,SPECIES_VATGROWN,SPECIES_BOOSTER,SPECIES_TRITONIAN,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_YEOSA,SPECIES_SHELL,SPECIES_CUSTOM,SPECIES_TAJ)
	required_language = LANGUAGE_HUMAN_EURO
	min_skill = list(
