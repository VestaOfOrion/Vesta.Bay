...
/datum/uplink_item/item/tools/personal_shield
	...
	desc = "A very expensive device that uses energy to block bullets and lasers from tearing you a new hole, effectively making you bulletproof as long as it's in your hands."
	item_cost = 60
...
/datum/uplink_item/item/tools/handcuffs
	name = "Handcuffs"
	desc = "A pair of handcuffs, for restraining people. Remember to ask for consent."
	item_cost = 1
...
/datum/uplink_item/item/tools/nabbergloves
	...
	desc = "Insulated gloves, for Serpentids. Does the Syndicate employ Serpentids? So many questions!"
	item_cost = 4
