...
/obj/structure/closet/secure_closet/explorer
	name = "explorer's locker - regular"
...
/obj/structure/closet/secure_closet/explorer/technician
	name = "explorer's locker - technician"
	req_access = list(access_explorer)
	closet_appearance = /decl/closet_appearance/secure_closet/torch/exploration
...
/obj/structure/closet/secure_closet/explo
	name = "longarm locker"
	desc = "Wall locker holding the exploration longarms."
...
/obj/structure/closet/secure_closet/explo/WillContain()
	return list(
		/obj/item/weapon/gun/projectile/automatic/bullpup_rifle/exploration = 3,
		/obj/item/ammo_magazine/mil_rifle/sec/large = 6,
		/obj/item/weapon/grenade/light = 10,
		/obj/item/weapon/gun/projectile/automatic/sec_smg/exploration = 2,
		/obj/item/ammo_magazine/smg_top = 6
	)

/decl/closet_appearance/wall/explo
	color = COLOR_GRAY20
	decals = null
	can_lock = 1
	extra_decals = list(
