/decl/cultural_info/culture/ipc
    ...
    a group of organizations that spreads its message far and wide. Synthetic rights , specifically the rights of positronic chassis, exploded during the late 2300’s, remaining relevant even two centuries later. \
