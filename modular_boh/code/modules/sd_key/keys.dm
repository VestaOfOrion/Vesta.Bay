/obj/item/weapon/sd_key
	...
	icon = 'modular_boh/icon/boh/items/sd_keys.dmi'
	icon_state = "key_base"
...
/obj/item/weapon/sd_key/on_update_icon()
	if(skeleton_key)
		overlays += image('modular_boh/icon/boh/items/sd_keys.dmi', "skeleton_key")
		return //we don't do any of the fancy stuff if we're a skeleton key.
	overlays += image('modular_boh/icon/boh/items/sd_keys.dmi', "trefoil")

	if(ownertag)
		overlays += image('modular_boh/icon/boh/items/sd_keys.dmi', "imprint_[ownertag]")
		return
	else
		overlays.Cut()
		overlays += image('modular_boh/icon/boh/items/sd_keys.dmi', "trefoil")