/datum/species/teshari
	...
	icobase = 'modular_boh/icon/mob/species/teshari/body.dmi'
	preview_icon = 'modular_boh/icon/mob/species/teshari/preview.dmi'
	deform = 'modular_boh/icon/mob/species/teshari/r_resomi.dmi'
	damage_overlays = 'modular_boh/icon/mob/species/teshari/masks/dam_resomi.dmi'
	damage_mask = 'modular_boh/icon/mob/species/teshari/masks/dam_mask_resomi.dmi'
	blood_mask = 'modular_boh/icon/mob/species/teshari/masks/blood_resomi.dmi'
